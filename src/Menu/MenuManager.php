...
class MenuManager
{
    ...
    public function route($data, $text, $icon = '', $attributes = [], $per = '', $sort = -1, $_position = ''): MenuBuilder
    {
        return $this->position($_position)->route($data, $text, $icon, $attributes, $per, $sort);
    }
    public function component($data, $text, $icon = '', $attributes = [], $per = '', $sort = -1, $_position = ''): MenuBuilder
    {
        return $this->position($_position)->component($data, $text, $icon, $attributes, $per, $sort);
    }
    public function action($data, $text, $icon = '', $attributes = [], $per = '', $sort = -1, $_position = ''): MenuBuilder
    {
