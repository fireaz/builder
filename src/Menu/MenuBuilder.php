...
use FireAZ\Builder\HtmlBuilder;
...
class MenuBuilder extends HtmlBuilder
{
    ...
    public function route($data, $text, $icon = '', $attributes = [], $per = '', $sort = -1): self
    {
        $this->items[] = new MenuItemBuilder([
    ...
    public function component($data, $text, $icon = '', $attributes = [], $per = '', $sort = -1): self
    {
        $this->items[] = new MenuItemBuilder([
    ...
    public function action($data, $text, $icon = '', $attributes = [], $per = '', $sort = -1): self
    {
        $this->items[] = new MenuItemBuilder([
